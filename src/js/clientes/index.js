...
const getclientes = async () => {
    ...
    const precio = formulario.cliente_precio.value
    const url = `/controllers/clientes/index.php?cliente_nombre=${nombre}&cliente_precio=${precio}`
    const config = {
        method: 'GET'
    }
        ...
        if (respuesta.status == 200) {
            ...
            if (data.length > 0) {
                data.forEach(cliente => {
                    ...
                    celda3.innerText = cliente.cliente_precio;
